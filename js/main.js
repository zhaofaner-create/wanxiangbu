(function (global) {
  ...
  var speechPrompter = require("./modules/speechPrompter.js");
  var profile = require("./modules/profile.js");
  var settings = require("./modules/settings.js");

  const MODULES = [home, todayPlan, studyTasks, reminders, mealPlan, inventory, finance, games, readingNotes, classNotes, speechPrompter, profile, settings];

  // 侧边导航按"日常/学习/生活/系统"分组展示，比一长条平铺的列表更容易一眼找到东西。
  const NAV_GROUPS = [
    { title: "日常", moduleIds: ["home", "todayPlan"] },
    { title: "学习", moduleIds: ["studyTasks", "reminders", "classNotes", "speechPrompter"] },
  ...
  const NAV_ICONS = {
    ...
    speechPrompter: '<rect x="5" y="3" width="14" height="14" rx="2"/><path d="M8 7.5h8M8 11h8M8 14.5h5"/><path d="m9 19.5 3 2.2 3-2.2"/>',
  ...
  const NAV_ICON_COLORS = {
    ...
    speechPrompter: ["hsl(95, 60%, 68%)", "hsl(95, 45%, 48%)"],
